      ...
      <div className="quran">
        <div className="fehres">
          ...
          {allSurah_s.map((surah, i) => (
            <div className="surah" key={i} onClick={() => {setCurrentSurahNass(i + 1);let el = document.getElementsByClassName('nass')[0] as HTMLDivElement;el.scrollTo({ top: 0, behavior: 'smooth' });}}>
