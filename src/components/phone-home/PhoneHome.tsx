...
export default function PhoneHome() {
  ...
  const [openedWerd, setOpenedWerd] = useState<boolean>(false);
    ...
    if (data?.length == 0) {
      ...
      if (data?.at(0).surah_num != null) {
        ...
        let int = setInterval(() => {
          ...
          if(el) el.scrollTo({ top: data?.at(0).scroll_top, behavior: 'smooth' });
          if (el) {
            clearInterval(int);
          }
        }, 100);
...
function handleClick(className: string, newPage: string) {
  const allElements = [
    document.getElementsByClassName('phone-home')[0] as SVGElement,
    document.getElementsByClassName('phone-home')[1] as HTMLDivElement,
    document.getElementsByClassName('phone-search')[0] as SVGElement,
    document.getElementsByClassName('phone-search')[1] as HTMLDivElement,
    document.getElementsByClassName('phone-azkar')[0] as SVGElement,
    document.getElementsByClassName('phone-azkar')[1] as HTMLDivElement,
    document.getElementsByClassName('phone-counter')[0] as SVGElement,
    document.getElementsByClassName('phone-counter')[1] as HTMLDivElement,
  ];
  ...
  if (newPage !== 'home') {
      setCurrentSurahNass(0);
      setCurrentPartNass(0);
  }
}

useEffect(() => {
  handleClick("phone-home", "home");
}, []);

function getPageWerd() {
  if (currentWerd < 10) {
    return  <img src={`https://github.com/AbdoAKAGames/Holy-Quran/blob/main/src/data/werd/pages/page00${currentWerd + 1}.png?raw=true`} alt="werd" className="phone-werd-img" />
  }
  else if (currentWerd >= 10 && currentWerd < 100) {
    return  <img src={`https://github.com/AbdoAKAGames/Holy-Quran/blob/main/src/data/werd/pages/page0${currentWerd + 1}.png?raw=true`} alt="werd" className="phone-werd-img" />
  }
  else if (currentWerd >= 100) {
    return  <img src={`https://github.com/AbdoAKAGames/Holy-Quran/blob/main/src/data/werd/pages/page${currentWerd + 1}.png?raw=true`} alt="werd" className="phone-werd-img" />
  }
}
...
function handleBack() {
  ...
  return (
    ...
    <div id="phone-app" className="phone-app">
      {(currentSurahNass === 0 && currentPartNass === 0) && (
      ...
      <div className="phone-quran">
        ...
        {/* --- Surah List View --- */}
        {(currentSurahNass === 0 && currentPartNass === 0 && !openedWerd) && (
            <div className="phone-fehres">
                ...
                <div className="phone-surah-list-container">
                    {allSurah_s.filter(surah => surah.replace("أ", "ا").replace("آ", "ا").includes(surahSearchValue.replace("أ", "ا").replace("آ", "ا"))).map((surah, i) => (
                        <div className="phone-surah" key={i} onClick={() => {
                            setCurrentSurahNass(allSurah_s.indexOf(surah) + 1);
                            // Scroll reset handled in effect or after render
                        }}>
                ...
                {/* --- Parts List View (Displayed below Surah list in original, keeping it here but styled) --- */}
                 {/* --- Werd Button --- */}
            </div>
        )}

        {(currentSurahNass === 0 && currentPartNass === 0 && !openedWerd) && <div className="phone-parts">
        ...
        <div className="phone-reading-view">
           <div className="phone-reading-header">
                ...
                <span>سورة {allSurah_s[currentSurahNass - 1]}</span>
           </div>
        ...
        <div className="phone-nass">
          ...
          <div className="phone-surah-nass">
            {currentSurahNass == 1 || currentSurahNass == 9 ? surah_nass[currentSurahNass - 1] : <><div className="phone-basmalah">بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ</div> {surah_nass[currentSurahNass - 1]}</>}
          </div>
        </div>
        ...
        <div className="phone-listen-surah">
          ...
          <div className="phone-buttons">
            <div className="phone-next">
              <button disabled={currentSurahNass == 114 ? true : false} onClick={() => {setCurrentSurahNass(cu => cu + 1);let el = document.getElementsByClassName('phone-nass')[0] as HTMLDivElement;if(el) el.scrollTo({ top: 0, behavior: 'smooth' })}}>التالية</button>
            </div>
            <div className="phone-prev">
              <button disabled={currentSurahNass == 1 ? true : false} onClick={() => {setCurrentSurahNass(cu => cu - 1);let el = document.getElementsByClassName('phone-nass')[0] as HTMLDivElement;if(el) el.scrollTo({ top: 0, behavior: 'smooth' })}}>السابقة</button>
            </div>
          </div>
      ...
      {currentPartNass > 0 &&
        <div className="phone-reading-view">
            <div className="phone-reading-header">
                ...
                <span>الجزء {currentPartNass}</span>
           </div>
              <div className="phone-quran-part-nass">
                <div className="phone-quran-part-nass-name">
                الجزء {currentPartNass}
                </div>
                <div className="phone-quran-part-nass-text">
            ...
            <div className="phone-listen-surah">
                <div className="phone-save-button">
                    <button onClick={() => {savePart();savedRefPart.current?.setAttribute('style', 'display: flex;');}}>حفظ</button>
                    <button onClick={() => {unsavePart();unsavedRefPart.current?.setAttribute('style', 'display: flex;');}}>إلغاء</button>
                </div>
                <div className="phone-buttons">
                    <div className="phone-next">
                    <button disabled={currentPartNass == 30 ? true : false} onClick={() => {setCurrentPartNass(cu => cu + 1);let el = document.getElementsByClassName('phone-quran-part-nass')[0] as HTMLDivElement;if(el) el.scrollTo({ top: 0, behavior: 'smooth', })}}>التالي</button>
                    </div>
                    <div className="phone-prev">
                    <button disabled={currentPartNass == 1 ? true : false} onClick={() => {setCurrentPartNass(cu => cu - 1);let el = document.getElementsByClassName('phone-quran-part-nass')[0] as HTMLDivElement;if(el) el.scrollTo({ top: 0, behavior: 'smooth', })}}>السابق</button>
                    </div>
                </div>
                <div className="phone-listen" onClick={() => setListenPart(true)}>
                استماع
                </div>
            </div>
        </div>
      ...
      {openedWerd && <div className="phone-reading-view">
            <div className="phone-reading-header">
                <button className="phone-back-btn" onClick={handleBack}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                    رجوع
              ...
              <div className="phone-werd-container">
                ...
                <div className="phone-werd-text">
                  ...
                  {dailyWerd == 'phone-hezb' && allHezb[currentWerd]}
                  {dailyWerd == 'phone-part' && allParts[currentWerd]}
                </div>
              </div>
            </div>
        </div>
      ...
      {listen && <div className="phone-choose-qaree-modal" onClick={() => setListen(false)}>
        <div className="phone-choose-qaree" onClick={e => e.stopPropagation()}>
      ...
      {listenPart && 
      <div className="phone-choose-qaree-modal" onClick={() => setListenPart(false)}>
      <div className="phone-choose-qaree" onClick={e => e.stopPropagation()}>
        <div className="phone-choose-qaree-title">
          اختر أحد القراء
        </div>
        <div className="phone-quraa">
          {quraa.map((qaree, i) => (
            <div className="phone-qaree" key={i} onClick={() => listenParts(qaree.name)}>
            <div className="phone-qaree-image">
              <img src={qaree.image} />
            </div>
            <div className="phone-qaree-name">
      ...
      {/* Display Werd */}
      {startedWerd && (currentSurahNass === 0 && currentPartNass === 0) && !openedWerd && <>
      <div className="phone-werd-buttons">
        <div className="phone-open-daily-werd" onClick={() => setOpenedWerd(true)}>ورد اليوم</div>
...
{currentPage == 'counter' && <Counter />}
       ...
       {currentSurahNass === 0 && currentPartNass === 0 && !openedWerd && <div className="phone-tools">
       <div className="phone-tool" onClick={() => {handleClick('phone-counter', 'counter')}}>
          <div className="phone-tool-img">
          <svg className="phone-counter" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="24" height="24" fill="#9ca3af">
          ...
          <div className="phone-tool-name phone-counter">
            المسبحة
          </div>
        </div>
        <div className="phone-tool" onClick={() => {handleClick('phone-azkar', 'azkar')}}>
          <div className="phone-tool-img">
          <svg xmlns="http://www.w3.org/2000/svg" className="phone-azkar" version="1.0" width="24" height="24" viewBox="0 0 1280.000000 1118.000000" preserveAspectRatio="xMidYMid meet" fill="#9ca3af">
          ...
          <div className="phone-tool-name phone-azkar">
            الأذكار
          </div>
        </div>
        <div className="phone-tool" onClick={() => {handleClick('phone-search', 'search')}}>
          <div className="phone-tool-img">
          <svg xmlns="http://www.w3.org/2000/svg" className="phone-search" width="24" height="24" viewBox="0 0 24 24" fill="#9ca3af">
            <path d="M 9 2 C 5.1458514 2 2 5.1458514 2 9 C 2 12.854149 5.1458514 16 9 16 C 10.747998 16 12.345009 15.348024 13.574219 14.28125 L 14 14.707031 L 14 16 L 20 22 L 22 20 L 16 14 L 14.707031 14 L 14.28125 13.574219 C 15.348024 12.345009 16 10.747998 16 9 C 16 5.1458514 12.854149 2 9 2 z M 9 4 C 11.773268 4 14 6.2267316 14 9 C 14 11.773268 11.773268 14 9 14 C 6.2267316 14 4 11.773268 4 9 C 4 6.2267316 6.2267316 4 9 4 z"></path>
          </svg>
          </div>
          <div className="phone-tool-name phone-search">
            الباحث القرآني
          </div>
        </div>
        <div className="phone-tool phone-first" onClick={() => {handleClick('phone-home', 'home')}}>
          <div className="phone-tool-img">
            <svg xmlns="http://www.w3.org/2000/svg" className="phone-home" width="24" height="24" viewBox="0 0 24 24" fill="#9ca3af">
              <path d="M 12 2 A 1 1 0 0 0 11.289062 2.296875 L 1.203125 11.097656 A 0.5 0.5 0 0 0 1 11.5 A 0.5 0.5 0 0 0 1.5 12 L 4 12 L 4 20 C 4 20.552 4.448 21 5 21 L 9 21 C 9.552 21 10 20.552 10 20 L 10 14 L 14 14 L 14 20 C 14 20.552 14.448 21 15 21 L 19 21 C 19.552 21 20 20.552 20 20 L 20 12 L 22.5 12 A 0.5 0.5 0 0 0 23 11.5 A 0.5 0.5 0 0 0 22.796875 11.097656 L 12.716797 2.3027344 A 1 1 0 0 0 12.710938 2.296875 A 1 1 0 0 0 12 2 z"></path>
            </svg>
          </div>
          <div className="phone-tool-name phone-home">
            الرئيسية
          </div>
        </div>
       </div>}
